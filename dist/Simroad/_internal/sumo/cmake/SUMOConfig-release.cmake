...
set_target_properties(SUMO::libsumocpp PROPERTIES
  ...
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "fmt::fmt;Parquet::parquet_shared"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/libsumocpp.dll"
  )

list(APPEND _cmake_import_check_targets SUMO::libsumocpp )
list(APPEND _cmake_import_check_files_for_SUMO::libsumocpp "${_IMPORT_PREFIX}/bin/libsumocpp.lib" "${_IMPORT_PREFIX}/bin/libsumocpp.dll" )
...
list(APPEND _cmake_import_check_files_for_SUMO::libtracicpp "${_IMPORT_PREFIX}/bin/libtracicpp.lib" "${_IMPORT_PREFIX}/bin/libtracicpp.dll" )
